...
import  Blossomswhite from  "../assets/blossoms white.png";
...
const Footer = () => {
  return (
    ...
    <footer className="w-full bg-primary text-white p-8  px-4 ">
      <div className="w-full mx-auto px-10 ">
        ...
        <div className="grid grid-cols-2 gap-12 sm:grid-cols-4 lg:grid-cols-5 pb-8 border-b border-white">
          ...
          <div className="col-span-2 lg:col-span-1 mb-8 sm:mb-0">
            ...
            <p className="text-sm mb-4">blossoms.com</p>
            <div className="flex space-x-4">
              {/* Social Icons (using React Icons) */}
              <a href="#" className="hover:text-pink-400"><FaFacebookF className="text-xl p-1 border rounded-full" /></a>
              <a href="#" className="hover:text-pink-400"><FaInstagram className="text-xl p-1 border rounded-full" /></a>
              <a href="#" className="hover:text-pink-400"><FaTwitter className="text-xl p-1 border rounded-full" /></a>
              {/* The 'X' icon for the last one (using FaTimes as a placeholder/stylistic choice) */}
              <a href="#" className="hover:text-pink-400"><FaTimes className="text-xl p-1 border rounded-full" /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-purple-200">
              {shoppingLinks.map((link) => (
                <li key={link}>
                  <a href="#" className="text-white hover:text-pink-400">{link}</a>
                </li>
              ))}
            </ul>
          </div>
